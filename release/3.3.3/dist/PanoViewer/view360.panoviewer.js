...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@egjs/axes'), require('@egjs/component'), require('@egjs/agent'), require('gl-matrix')) :
  typeof define === 'function' && define.amd ? define(['exports', '@egjs/axes', '@egjs/component', '@egjs/agent', 'gl-matrix'], factory) :
  (factory((global.eg = global.eg || {}, global.eg.view360 = {}),global.eg.Axes,global.eg.Component,global.eg.Agent,global.glMatrix));
}(this, (function (exports,Axes,Component,Agent,glMatrix) { 'use strict';
  ...
  */
  ...
  var agent$1 = Agent();
  var isIE11 = agent$1.browser.name === "ie" && agent$1.browser.majorVersion === 11;
  var EVENTS = {
    ERROR: "error"
  };
  /**
    ...
    function (_Renderer) {
      ...
      _proto.getMaxCubeMapTextureSize = function getMaxCubeMapTextureSize(gl, image) {
        ...
        if (agent.os.name === "ios") {
          var majorVersion = agent.os.majorVersion; // ios 9 의 경우 텍스쳐 최대사이즈는 1024 이다.
