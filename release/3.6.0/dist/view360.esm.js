...
function (_super) {
  ...
  __proto._initYawPitchControl = function (yawPitchConfig) {
    ...
    this._yawPitchControl.on("change", function (e) {
      ...
      _this.trigger(new ComponentEvent(PANOVIEWER_EVENTS.VIEW_CHANGE, e));
    });
  };
